(function (e, t) {
  ...
  function i(e) {
    ...
    if (e.material) {
      Object.keys(e.material).forEach(t => {
        if (e.material[t] && e.material[t] !== null && typeof e.material[t].dispose == "function") {
  ...
  n.VantaBase = class {
    constructor(e = {}) {
      ...
      if (e instanceof HTMLElement || typeof e == "string") {
        e = {
          el: e
        };
      }
      ...
      if (this.el == null) {
        ...
        const e = this.el;
        this.el = (i = e, document.querySelector(i));
        if (!this.el) {
          r("Cannot find element", e);
          return;
        }
      }
      var i;
      ...
      try {
        ...
        if (this.options.backgroundColor) {
          ...
          this.el.style.background = (h = this.options.backgroundColor, typeof h == "number" ? "#" + ("00000" + h.toString(16)).slice(-6) : h);
        }
        return;
      }
      this.initMouse();
    ...
    prepareEl() {
      ...
      for (e = 0; e < this.el.children.length; e++) {
        ...
        if (getComputedStyle(t).zIndex === "auto") {
          t.style.zIndex = 1;
        }
      }
    ...
    windowMouseMoveWrapper(e) {
      ...
      const o = e.clientY - t.top;
      if (i >= 0 && o >= 0 && i <= t.width && o <= t.height) {
        this.mouseX = i;
        this.mouseY = o;
        if (!this.options.mouseEase) {
          this.triggerMouseMove(i, o);
        }
      }
    }
    windowTouchWrapper(e) {
      ...
      if (e.touches.length === 1) {
        ...
        const o = e.touches[0].clientY - t.top;
        if (i >= 0 && o >= 0 && i <= t.width && o <= t.height) {
          this.mouseX = i;
          this.mouseY = o;
          if (!this.options.mouseEase) {
    ...
    windowGyroWrapper(e) {
      ...
      const i = Math.round(e.alpha * 2) - t.left;
      const o = Math.round(e.beta * 2) - t.top;
      if (i >= 0 && o >= 0 && i <= t.width && o <= t.height) {
        this.mouseX = i;
        this.mouseY = o;
        if (!this.options.mouseEase) {
    ...
    triggerMouseMove(e, t) {
      ...
      const o = t / this.height;
      if (typeof this.onMouseMove == "function") {
        this.onMouseMove(i, o);
      }
    }
    setSize() {
      this.scale ||= 1;
      if (typeof navigator != "undefined" && (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || window.innerWidth < 600) && this.options.scaleMobile) {
  ...
  const h = n.VantaBase;
  let a = typeof window == "object" && window.THREE;
  class l extends h {
    constructor(e) {
      a = e.THREE || a;
    ...
    initBasicShader(e = this.fragmentShader, t = this.vertexShader) {
      ...
      const o = this.options.texturePath;
      if (o) {
        this.uniforms.iTex = {
          type: "t",
